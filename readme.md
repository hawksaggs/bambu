...
## Guildlines to run the application
- You should have nodejs and elasticsearch install or use any cloud host url and make sure it is running
- Make .env file and add 
    ELASTICSEARCH_HOST = http://localhost:9200 or cloud host url
    ELASTICSEARCH_LOG_LEVEL = error
- Go to bambu folder and run nodejs server by typing npm start
- To import the data into elasticsearch call import api.
- To search the data call people-like-you api with query paramters mention above